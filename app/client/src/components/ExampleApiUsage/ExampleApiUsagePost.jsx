...
const ExampleApiUsagePost = (props) => {
    ...
    useEffect(() => {
        console.log("ENVIEM UNA CRIDA POST A L'API AL MUNTAR EL COMPONENT AMB postData");
    ...
    useEffect(() => {
        console.log("PODEM UTILITZAR UN USEFFECT PER CONTROLAR QUAN ENS VINGUI LA RESPOSTA DE L'API DEL RESULTAT DEL POST");
